...
void ui_SMainNoFLUpdateStats(const char* typeStr, const char* avgStr, float speedAvg, float speedMax,  float temperature, uint32_t dist, uint32_t time, float height);
